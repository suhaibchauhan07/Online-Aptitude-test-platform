    ...
    <div className="max-w-6xl mx-auto p-4 md:p-10 min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        ...
        <TiltCard className="p-4 rounded-2xl bg-gradient-to-br from-amber-50 to-yellow-50 border border-amber-100 shadow-md">
          ...
          <div className="text-sm font-semibold text-amber-900">{profile?.year || "-"}</div>
        </TiltCard>
        <TiltCard className="p-4 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 shadow-md">
          <div className="text-xs text-blue-700">Section</div>
          <div className="text-sm font-semibold text-blue-900">{profile?.section || "-"}</div>
        </TiltCard>
        ...
        <TiltCard className="bg-white/80 backdrop-blur-xl border border-white/60 rounded-3xl shadow-xl p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              {editSection === "all" ? (
                <input name="section" value={profile?.section || ""} onChange={handleChange} className="border rounded px-3 py-2 w-full text-lg" />
              ) : (
                <div className="font-semibold text-lg">{profile?.section || "-"}</div>
              )}
            </div>
          </div>
          ...
          {editSection === "all" && (
            <div className="mt-6 flex gap-2">
              <Button size="sm" onClick={() => handleSave("all")}>Save Changes</Button>
