...
export default function FacultyForgotPasswordPage() {
  ...
  const lookupEmail = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${API_BASE_URL}/faculty/forgot-password/lookup-email`, {
        method: "POST",
  ...
  const requestOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/faculty/forgot-password/request-otp`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const verifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}/faculty/forgot-password/verify-otp`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const resetPwd = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${API_BASE_URL}/faculty/forgot-password/reset`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      <div className="max-w-xl mx-auto p-4">
        <Card className="shadow-xl border border-blue-100">
          <CardHeader>
            ...
            <CardDescription>Reset your faculty account password</CardDescription>
          </CardHeader>
            ...
            {stage === "email" && (
              <form onSubmit={lookupEmail} className="space-y-3">
                ...
                <div className="text-sm text-slate-600">
                  <Link href="/faculty/login" className="text-blue-600 hover:underline">Back to login</Link>
                </div>
              </form>
            )}
            ...
            {stage === "done" && (
              <div className="space-y-3">
                ...
                <Button asChild className="w-full">
                  <Link href="/faculty/login">Go to Login</Link>
                </Button>
              </div>
            )}
          </CardContent>
